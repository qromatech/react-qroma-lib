...
import { createMessageInstanceWithDefaultValues } from "./proto-components/message-builder/builder_utils";
...
export const QromaRequestForm2 = <TCommand extends object, TResponse extends object>(props: IQromaRequestFormProps<TCommand, TResponse>) => {
  ...
  const onNewRootMessageValue = (newRootMessageValue: any) => {
    ...
    // const updatedQromaCommCommand = props.qromaWebSerial.createQromaCommMessageForAppCommand(rootMessage);
  ...
  const promptUserForJson = () => {
    ...
    if (userJson) {
      ...
      // setRootMessageJson(newRequestObjectData);
    }
  }
